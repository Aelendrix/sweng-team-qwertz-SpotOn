...
public class LocalDatabaseTestUtils {
    ...
    public static void initLocalDatabaseMockUser(boolean onlyOnePhoto) throws InterruptedException {
        ServicesChecker.allowDisplayingToasts(false);
        Location location = new Location("testLocationProvider");
        location.setLatitude(0.52890355757888);
        location.setLongitude(0.569420238493888);
        ...
        User user = new MockUser_forTests("jean","test","114110565725225", 0, new HashMap<String,Long>(), true, true);

        TestInitUtils.initContextMockUserAndLocation(user, location);
