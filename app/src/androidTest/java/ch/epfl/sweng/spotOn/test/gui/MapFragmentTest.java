// This test was in AndroidTest (with a majuscule) and therefore was not run by jenkins before.
// it needs fixing, which is why it's commented
//
...
//
//
//    public void goToMapFragmentAndSwipeMap() throws Exception {
